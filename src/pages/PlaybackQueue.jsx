...
export function PlaybackQueue({ data, busy, act, music, receiving, setReceiving, musicError, openTrack, onAdd, onSettings }) {
  ...
  return <section aria-label="File d’attente commune">
    ...
    {appleMine && <div className="pc-player"><h3>Ton lecteur Apple Music</h3>
      ...
      <div className="pc-play-actions"><Button variant="primary" disabled={busy || !music || !data.apple.connected} onClick={() => void act(async () => {
