...
export function findById(id) {
  return db.prepare(`SELECT id, email, name, role, token_version, can_view_stairs, can_view_quests, can_edit_quests, can_view_vault, wants_quest_reminders, created_at FROM users WHERE id = ?`).get(id);
}
...
export function listUsers() {
  return db.prepare(`SELECT id, email, name, role, can_view_stairs, can_view_quests, can_edit_quests, can_view_vault, wants_quest_reminders, created_at FROM users ORDER BY id`).all();
}
